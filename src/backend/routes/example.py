...
EXAMPLE_MEMORY = {
    ...
    "results": [
        ...
        {"item": "2026년 2월 생산량", "judgment": "일치", "verified": True},
        {"item": "2026년 3월 생산량", "judgment": "불일치", "verified": False},
        {"item": "2026년 4월 생산량", "judgment": "일치", "verified": True},
        ...
        {"item": "C지역 매출", "judgment": "일치", "verified": True},
        {"item": "D지역 매출", "judgment": "일치", "verified": True},
        {"item": "E지역 매출", "judgment": "일치", "verified": True},
        {"item": "인건비 총액", "judgment": "일치", "verified": True},
        {"item": "마케팅비", "judgment": "일치", "verified": True},
        {"item": "순이익", "judgment": "일치", "verified": True},
        {"item": "F지역 매출", "judgment": "값은 있으나 항목 대응이 다름", "verified": False},
        {"item": "G지역 매출", "judgment": "값은 있으나 항목 대응이 다름", "verified": False},
        {"item": "H지역 매출", "judgment": "원본에 없음", "verified": False},
        {"item": "I지역 매출", "judgment": "확인 불가", "verified": False},
        {"item": "J지역 매출", "judgment": "확인 불가", "verified": False},
        {"item": "K지역 매출", "judgment": "값은 있으나 항목 대응이 다름", "verified": False},
    ],
    "fixed_text": "",
}
